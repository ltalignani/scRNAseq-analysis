...
def all_input(wildcards):
    ...
    wanted_input.extend(
        expand(
            [
                ...
                "results/plots/preprocessing/all.QC-nCount_nFeatures.pdf",
    ...
    if config["clustering"]["activate"]:
        wanted_input.extend(
            expand("results/plots/clustering/all.Dim-plot.pdf"),
        )
        ...
        wanted_input.extend(
            expand(
                [
                    ...
                    "results/plots/seurat/integration/per_celltype/{model}.top-markers-plot.pdf",
