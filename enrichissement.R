...
expression_file <- read.csv("/Users/loictalignani/Downloads/results/tables/seurat/integration/wt_vs_ko.diff-exp-genes.tsv", sep = ",", header = TRUE)
...
print(paste("Nombre de gènes retenus pour l'enrichissement :", nrow(ensembl_list)))
...
if (is.null(ego2_cc)) print("Aucun résultat pour GO:CC")
if (is.null(ego2_bp)) print("Aucun résultat pour GO:BP")
if (is.null(ego2_mf)) print("Aucun résultat pour GO:MF")
...
print(head(genelist))
print(paste("Nombre de gènes dans genelist :", length(genelist)))
...
if (!is.null(pathway)) {
  ...
  write.csv(pathway_table, file = "/Users/loictalignani/Downloads/results/tables/seurat/integration/pathway.tsv", quote = FALSE)
...
create_barplot(ego2_cc, "/Users/loictalignani/Downloads/results/tables/seurat/integration/barplot_cc.pdf")
create_barplot(ego2_bp, "/Users/loictalignani/Downloads/results/tables/seurat/integration/barplot_bp.pdf")
create_barplot(ego2_mf, "/Users/loictalignani/Downloads/results/tables/seurat/integration/barplot_mf.pdf")
  ...
  if (!is.null(result) && nrow(result) > 0) {
    if (plot_type == "dotplot") {
      p <- dotplot(result, showCategory = min(showCategory, nrow(result))) +
        ...
        theme(
          axis.text.y = element_text(size = 6), # Réduction de la taille du texte de l'axe Y
...
create_plot(ego2_cc, "/Users/loictalignani/Downloads/results/tables/seurat/integration/dotplot_c.pdf", "dotplot")
create_plot(ego2_bp, "/Users/loictalignani/Downloads/results/tables/seurat/integration/dotplot_bp.pdf", "dotplot")
create_plot(ego2_mf, "/Users/loictalignani/Downloads/results/tables/seurat/integration/barplot_bp.pdf", "dotplot")
...
create_treeplot(ego2_cc, "/Users/loictalignani/Downloads/results/tables/seurat/integration/treeplot_cc.pdf")
create_treeplot(ego2_bp, "/Users/loictalignani/Downloads/results/tables/seurat/integration/treeplot_bp.pdf")
create_treeplot(ego2_mf, "/Users/loictalignani/Downloads/results/tables/seurat/integration/treeplot_mf.pdf")

# Enrichment Map corrigée avec pairwise_termsim
...
create_enrichment_map <- function(result, output_path, showCategory = 50) {
  if (!is.null(result) && nrow(result) > 0) {
    ...
    if (!is.null(result)) {
      # Limitation des catégories pour éviter les problèmes mémoire
      p1 <- emapplot(result, cex_category = 1.5, layout.params = list(layout = "kk"), showCategory = showCategory)
      p2 <- emapplot(result, cex_category = 1.5, layout.params = list(layout = "fr"), showCategory = showCategory)
...
create_enrichment_map(ego2_cc, "/Users/loictalignani/Downloads/results/tables/seurat/integration/enrichment_map_cc.pdf")
create_enrichment_map(ego2_bp, "/Users/loictalignani/Downloads/results/tables/seurat/integration/enrichment_map_bp.pdf")
create_enrichment_map(ego2_mf, "/Users/loictalignani/Downloads/results/tables/seurat/integration/enrichment_map_mf.pdf")
  ...
  if (!is.null(result) && nrow(result) > 0) {
    ...
    upset_plot <- upsetplot(result) +
      theme(
        ...
        axis.text.y = element_text(size = 8), # Taille des textes des catégories (axe Y)
